...
<body>
    ...
    <main>
        <section id="concept">
            <p><img src="tpl/img/concept_firstview.png" alt="日本家屋風のお店"></p>
                <div id="txt">
        ...
        <section id="gallery">
            ...
            <div class="loopSlider">
                <ul>
                    <li><img src="tpl/img/gallery01.png" alt="チョコレートケーキ"></li>
                    <li><img src="tpl/img/gallery02.png" alt="店内の様子"></li>
                    <li><img src="tpl/img/gallery03.png" alt="チョコレートケーキとコーヒー"></li>
                    <li><img src="tpl/img/gallery01.png" alt="チョコレートケーキ"></li>
                    <li><img src="tpl/img/gallery02.png" alt="店内の様子"></li>
                    <li><img src="tpl/img/gallery03.png" alt="チョコレートケーキとコーヒー"></li>
                    <li><img src="tpl/img/gallery01.png" alt="チョコレートケーキ"></li>
